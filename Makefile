...
get_unix_target = $(RELEASE_DIR)/$(BINARY_NAME)_$(call get_goos,$1)_$(call get_goarch,$1)
get_win_target = $(RELEASE_DIR)/$(BINARY_NAME)_$(call get_goos,$1)_$(call get_goarch,$1).exe
